...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        USER_RESOURCE.add("invoice.jsp");
        USER_RESOURCE.add("productInfo.jsp");

        ADMIN_RESOURCE = new ArrayList<>();
        ADMIN_RESOURCE.add("admin.jsp");
        ADMIN_RESOURCE.add("user.jsp");
        ADMIN_RESOURCE.add("viewCart.jsp");
        ADMIN_RESOURCE.add("invoice.jsp");
        ADMIN_RESOURCE.add("productInfo.jsp");
        ADMIN_RESOURCE.add("shop.jsp");
        ADMIN_RESOURCE.add("requestPassword.jsp");
        ADMIN_RESOURCE.add("resetPassword.jsp");
        ADMIN_RESOURCE.add("login.jsp");
        ADMIN_RESOURCE.add("create.jsp");               
        ...
        NON_AUTHEN_RESOURCE.add("ResetPasswordController");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (checkContain || resource.endsWith(".css") || resource.endsWith(".js")
                    || uri.contains("cdnjs")
                    || uri.contains("jsdelivr")
                    || uri.contains("googleapis")
                    || uri.contains("shop.jsp")) {
