...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="collapse navbar-collapse" id="productNavbar">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item line active">
                                    <a class="nav-link" aria-current="page" href="#">PRODUCT INFO</a>
                                </li>
                                <li class="nav-item line">
        ...
        <!-- PRODUCT INFO -->
        <section id="product-info" class="product-info section">
            <div class="container-md">
                <h2 class="product-info-title section-title">PRODUCT INFO</h2>
                <c:if test="${requestScope.PRODUCT_INFO != null}">
                    <c:if test="${not empty requestScope.PRODUCT_INFO}">
                        <form action="MainController" mehtod="POST">
                            <div class="tab-wrapper row d-flex text-start py-4">
                                <div class="col-4">
                                    <img src="${requestScope.PRODUCT_INFO.image}" class="product-info__img img-fluid w-100" />
                                </div>
                                <div class="col-6 d-flex flex-column">
                                    <div class="product-info__title">
                                        <h2 class="product-info__name">${requestScope.PRODUCT_INFO.name}</h2>
                                    </div>
                                    <div class="product-info__price py-4 my-4">
                                        <h5 class="price-info">
                                            <fmt:formatNumber
                                                value="${requestScope.PRODUCT_INFO.price * requestScope.PRODUCT_INFO.quantity}"
                                                type="number"
                                                minFractionDigits="3"
                                                maxFractionDigits="3"
                                                />VND
                                    ...
                                    <div class="product-info__description pb-3">
                                        <p>
                                            Our high-quality stationery items are designed to meet all your office and school needs. Whether you're jotting down notes, organizing your workspace, or adding a touch of creativity to your projects, our stationery collection offers the perfect tools. Crafted with durability and style in mind, each item in our range ensures reliability and ease of use.Discover the perfect blend of functionality and design with our versatile stationery solutions.
                                        </p>
                                    </div>
                                    <div class="product-info__quantity pb-3">
                                        <span>Quantity :</span>
                                        <div class="quantity-info">
                                            <button type="button" class="decrease-button">--</button>
                                            <input type="number" name="quantity" min="1" maxlength="4" value="${requestScope.PRODUCT_INFO.quantity}">
                                            <button type="button" class="increase-button">+</button>
                                        </div>
                                    </div>                        
                                    <div class="product-info__options text-center pt-2">
                                        <div class="product-info__option">
                                            <button class="heart-button">
                                                <a><i class="bi bi-heart-fill"></i></a>
                                            </button>
                                        </div>
                                        <div class="product-info__option">
                                            <input type="hidden" name="productID" value="${requestScope.PRODUCT_INFO.productID}">
                                            <input type="hidden" name="quantity" value="${requestScope.PRODUCT_INFO.quantity}">
                                            <input type="hidden" name="indexTab" value="${requestScope.TAB}">  
                                            <button type="submit" name="action" value="Add" class="cart-button">
