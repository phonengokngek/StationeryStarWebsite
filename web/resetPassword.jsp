                                    ...
                                    <div class="row gy-2 overflow-hidden">                                        
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control" name="email" value="${requestScope.EMAIL}" id="email" placeholder="name@example.com" required>
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid my-3">
                                                <button class="btn btn-dark btn-lg" type="submit" name="action" value="Reset_Password">Reset</button>
